...
case "${SAUCE_CONNECT_PLATFORM}" in
    linux)
        ...
        SC_DISTRIBUTION_SHASUM=3bd70442329a240869eb1e41bc0ab2a9d885face;;
    osx)
        SC_DISTRIBUTION_FMT=zip
        SC_DISTRIBUTION_SHASUM=ae017d7d2bfe63989b22f8f913ee4de010b221d7;;
esac
SC_DISTRIBUTION=sc-4.3-${SAUCE_CONNECT_PLATFORM}.${SC_DISTRIBUTION_FMT}

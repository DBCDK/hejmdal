...
import {initialize, authenticate} from '../components/identityprovider/identityprovider.component';
...
router.get('/:token/:id', initialize, authenticate, getTicket, ctxdump);

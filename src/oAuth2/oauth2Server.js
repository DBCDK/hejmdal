/**
 * @file
 * This is a fork of https://github.com/oauthjs/express-oauth-server/. We need a more finegraned control of the flow
 * than express-oauth-server provides + the dependency tree is not up to date.
 */
